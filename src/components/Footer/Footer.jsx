        ...
        <footer className={css.footer}>
            <Zoom>
                <div className={css.iconSN}>
                    {/*https://t.me/item_ka*/}
                    <a href="tg://resolve?domain=item_ka" target="_blank"><img className={css.icon} src={telegram}
                                                                               alt=""/></a>
                    <a href="https://www.facebook.com/profile.php?id=100004583561001" target="_blank"><img
                        className={css.icon}
                        src={facebook} alt=""/></a>
                    <a href="https://www.instagram.com/item_ka/" target="_blank"><img className={css.icon}
                                                                                      src={instagram} alt=""/></a>
                    <a href="https://www.linkedin.com/in/artem-pavlenko-001b7a191/" target="_blank"><img
                        className={css.icon} src={linkedin}
                        alt=""/></a>
